/* @(#)scsireg.h	1.9 96/02/04 Copyr 1987 J. Schilling */
/*
...
struct	scsi_inquiry {
	...
	u_char	type_modifier	: 7;
	u_char	iso_version	: 2;	/*  2 */
	u_char	ecma_version	: 3;
	u_char	ansi_version	: 3;
	u_char	aenc		: 1;	/*  3 */
	u_char	termiop		: 1;
	u_char	res3_54		: 2;
...
struct scsi_format_header {
	...
	u_char			: 3;
	u_char	vu		: 1;
	u_short	length;			/* Length of following list in bytes*/
};
