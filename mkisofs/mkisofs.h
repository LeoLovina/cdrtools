...
extern void DECL (insert_boot_cat, (void));
...
extern int  DECL(sort_directory,(struct directory_entry **, int));
...
extern int
	DECL(open_merge_image,(char * path)); 
